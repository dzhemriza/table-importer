...
Import XML is used to define import settings that needed by application on order to move tabled data through tables.
...
<import>
	...
	<db_connection>
		...
		-->
		<connection name="MySQL" class="com.mysql.jdbc.Driver" user="root" pass="root" jar="file:/C:/temp/mysql-connector-java-5.1.10-bin.jar" url="some url"/>
	</db_connection>
	...
	<dest_table type="insert"> <!-- This is a example of inserting destination table -->
		...
		-->
		<fields>
			<field name="persons_id" type="FieldType.Integer" key_field="true"/>
			<field name="persons_name" type="FieldType.String" key_field="false"/>
			<field name="persons_age" type="FieldType.Integer" key_field="false"/>
			<field name="persons_address" type="FieldType.String" key_field="false"/>
		</fields>
	</dest_table>
	
	<dest_table type="delete"> <!-- This is a example of deleting destination table -->
		<!--
		This node is a link node between db connection and source table
		name attribute is link from db_connections list
		-->
		...
		<!--
		Defines using of key fields in where clause of sql statement
		-->
		<use_key_fields_as_where>true</use_key_fields_as_where>
		
		<!--
		Additional sql where statement
		-->
		<sql_where>1=1</sql_where>
	</dest_table>
	
	<dest_table type="update"> <!-- This is a example of updating destination table -->
		<!--
		This node is a link node between db connection and source table
		name attribute is link from db_connections list
		-->
	...
	<dest_table type="update_insert"> <!-- This is a example of updating and if update fails inserting destination table -->
		<!--
		This node is a link node between db connection and source table
		name attribute is link from db_connections list
		-->
